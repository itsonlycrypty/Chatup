          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white font-semibold text-sm">
                {p.userId === 'youtube_bot' ? 'Trending Videos' : (postUser?.displayName || 'Unknown')}
    ...
    return (
      <div key={s.id} className="relative h-screen w-full bg-black snap-start snap-always">
        ...
        <div className="absolute bottom-40 right-4 z-10 flex flex-col items-center gap-5">
          ...
          <button
            onClick={() => {
              // Focus comment input by setting commentText for this short
              // We'll just open the comment input; it's already rendered at bottom.
            }}
